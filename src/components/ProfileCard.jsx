...
export default function ProfileCard({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 animate-fadeIn">
      ...
      <div className="relative bg-gray-900/40 backdrop-blur-3xl rounded-3xl shadow-2xl border border-white/20 w-full max-w-2xl overflow-hidden animate-slideUp max-h-[90vh] overflow-y-auto">
        {/* Close Button */}
        <button
          onClick={handleClose}
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            ...
            <div className="group flex flex-col items-center gap-2 cursor-pointer">
              <div className="relative">
                <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition">
            ...
            <div className="group flex flex-col items-center gap-2 cursor-pointer">
              <div className="relative">
                <div className="w-14 h-14 bg-gradient-to-br from-gray-700 to-gray-900 rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition">
                  <svg viewBox="0 0 24 24" className="w-10 h-10 fill-white">
            ...
            <div className="group flex flex-col items-center gap-2 cursor-pointer">
              <div className="relative">
                <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition">
                  <svg viewBox="0 0 24 24" className="w-10 h-10 fill-white">
            ...
            <div className="group flex flex-col items-center gap-2 cursor-pointer">
              <div className="relative">
                <div className="w-14 h-14 bg-gradient-to-br from-red-600 to-red-700 rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition">
                  <svg viewBox="0 0 24 24" className="w-10 h-10 fill-white">
