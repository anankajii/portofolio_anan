...
export default function MobileSheet({ id, title, content, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end">
      ...
      <div
        ref={sheetRef}
        className={`relative bg-gray-900/95 backdrop-blur-2xl rounded-t-3xl border-t border-white/10 shadow-2xl transition-transform duration-300 ${visible ? 'translate-y-0' : 'translate-y-full'}`}
