...
function InstagramIcon() {
  return (
    <div className="w-full h-full rounded-2xl shadow-lg flex items-center justify-center overflow-hidden"
...
export default function Desktop() {
  ...
  const handleIconClick = (id) => {
    ...
    if (id === 'instagram') {
      window.open('https://www.instagram.com/', '_blank'); // ganti dengan username Instagram kamu
      return;
    }
    if (id === 'call') {
